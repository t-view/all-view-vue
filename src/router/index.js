...
export const constantRoutes = [
  ...
  },
  {
    path: '/zookeeper',
    component: Layout,
    meta: { title: 'zk管理', icon: 'el-icon-s-help' },
    name: 'zookeeper',
    redirect: '/zookeeper/table',
    children: [
      {
        path: 'node',
        name: 'node',
        component: () => import('@/views/zk/zk_node_manager'),
        meta: { title: 'zk节点管理', icon: 'tree' }
      },
      {
        path: 'cluster',
        name: 'cluster',
        component: () => import('@/views/zk/zk_cluster_manager'),
        meta: { title: 'zk集群管理', icon: 'table' }
      }
    ]
